...
//We can call this function as many times as we need to continue adding to the customerData.  This function also works to ensure the value doesn't already exist, and would replace the existing value is found.
...
$updateResponse = updateOrAddCustomAttribute($customerData,$customAttributeArray);
$customerData = $updateResponse['returnObj'];
